                    ...
                    <form action="{{ route('update-category') }}" method="post" class="form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8 radio">
                                <label > <input type="radio" name="pub_status" {{$category->pub_status==1 ?'checked':''}} value="1" checked>Published</label>
                                <label > <input type="radio" name="pub_status" {{$category->pub_status==0 ?'checked':''}} value="0" >Unpublished</label>
                            </div>
                        </div>
                        <div class="form-group">
